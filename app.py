...
ARTISTIC_EXAMPLES = [
    ...
    },
    {
        ...
        "label": "Classic Performance Car",
        "prompt": "classic performance car front view, polished chrome details, premium automotive branding aesthetic, dramatic studio lighting, photorealistic, sleek composition, high detail",
        "text_input": "https://velocegarage.co",
        "input_type": "URL",
        "image_size": 704,
        "border_size": 6,
        "error_correction": "Medium (15%)",
    ...
    },
    {
        ...
        "label": "Luxury Interior Brand",
        "prompt": "luxury interior design studio, premium wallpaper textures, elegant showroom styling, warm natural lighting, refined materials, photorealistic, clean composition, modern brand aesthetic, high detail",
        "text_input": "https://lumastudio.co",
        "input_type": "URL",
        "image_size": 704,
        "border_size": 6,
        "error_correction": "Medium (15%)",
...
_THEME = gr.themes.Base(
    ...
    # ── Dark mode overrides only (_dark suffix) ───────────────────────────
    # Non-_dark properties are left at Gradio's built-in light defaults so
    # that switching to Light or System mode in the settings panel works.
    ...
    block_radius="10px",
    block_shadow="0 4px 24px rgba(0,0,0,0.15)",
    input_radius="8px",
